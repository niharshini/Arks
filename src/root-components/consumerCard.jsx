...
export default function ConsumerCard({image, title, description, to, setSelectedProduct, detailDescription}) {
    const selectedProduct = () => {
        const product = {
            image, title, description: detailDescription
        } 
    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.container}>
                ...
                {to ? <div className={styles.button} style={{marginTop: "20px", width: "100%"}} onClick={selectedProduct}>
