  ...
  return (
    <div className={styles.aboutUsRevised}>
      ...
      <div className={styles.frameGroup}>
        ...
        <div className={styles.arksMicroelectronicsIndiaPvParent}>
          ...
          <div className={styles.arksMicroelectronicsIndia}>
            We are a technology-driven company committed to creativity and
            setting industry benchmarks. Our multitalented professionals are
            experts in their field, consistently delivering quality products.
            ARKS MicroElectronics is your trusted partner for innovative
            electronic solutions, redefining design and development.
          </div>
        </div>
      </div>
      <div className={styles.rectangleGroup}>
        <img className={styles.frameItem} alt="" src="/rectangle-22@2x.png" />
      ...
      <div className={styles.rectangleParent2}>
        <img className={styles.frameItem} alt="" src="/rectangle-222@2x.png" />
        <div className={styles.frameContainer}>
          <div className={styles.rectangleContainer}>
            <div className={styles.frameChild} />
            <div className={styles.ourMission}>Our Values</div>
          </div>
          <div className={styles.loremIpsumDolorContainer}>
            <p
              className={styles.p}
